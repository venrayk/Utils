 ...
 * 复制对象
 */
Utils.prototype.copyObject=function(source){
    var result={};
...
//加法
Utils.prototype.numberAdd=function (arg1, arg2) {
        if (!arg1) { arg1 = 0; }
        if (!arg2) { arg2 = 0; }
        var r1, r2, m;
 ...
 //减法
Utils.prototype.numberSub=function (arg1,arg2) {
        if (!arg1) { arg1 = 0; }
        if (!arg2) { arg2 = 0; }
...
//乘法
Utils.prototype.numberMul=function (arg1, arg2) {
        if (!arg1) { arg1 = 0; }
        if (!arg2) { arg2 = 0; }
...
//除法
Utils.prototype.numberDiv=function (arg1, arg2){
